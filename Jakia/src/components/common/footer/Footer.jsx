...
import logo from "../../../assets/images/portfolio-images/logoJakia-removebg-preview.png"

/* Footer nabLinks */
const navItems = [
  { id: 1, name: "Home", url: "introduction" },
  { id: 2, name: "About", url: "profile" },
  { id: 3, name: "Education", url: "services" },
  { id: 4, name: "Technical Skills", url: "workProcess" },
  { id: 5, name: "Projects", url: "portfolio" },
  { id: 6, name: "Hobbies", url: "blog" },
  {id: 7, name: "ExtraCurricular", url: 'extra_curricular'},
